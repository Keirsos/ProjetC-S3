...
${OBJECTDIR}/Visiteur.o: Visiteur.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Visiteur.o Visiteur.cpp
...
${TESTDIR}/tantQueTest.o: tantQueTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tantQueTest.o tantQueTest.cpp


${TESTDIR}/tantQueTestRunner.o: tantQueTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tantQueTestRunner.o tantQueTestRunner.cpp
...
${OBJECTDIR}/Visiteur_nomain.o: ${OBJECTDIR}/Visiteur.o Visiteur.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Visiteur_nomain.o Visiteur.cpp;\
	else  \
