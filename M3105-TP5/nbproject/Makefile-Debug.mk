...
# Test Object Files
TESTOBJECTFILES= \
	${TESTDIR}/tantQueTest.o \
	${TESTDIR}/tantQueTestRunner.o
...
${OBJECTDIR}/Visiteur.o: Visiteur.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Visiteur.o Visiteur.cpp
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tantQueTest.o ${TESTDIR}/tantQueTestRunner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   `cppunit-config --libs`   


${TESTDIR}/tantQueTest.o: tantQueTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tantQueTest.o tantQueTest.cpp


${TESTDIR}/tantQueTestRunner.o: tantQueTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tantQueTestRunner.o tantQueTestRunner.cpp
...
${OBJECTDIR}/Visiteur_nomain.o: ${OBJECTDIR}/Visiteur.o Visiteur.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/Visiteur.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Visiteur_nomain.o Visiteur.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/Visiteur.o ${OBJECTDIR}/Visiteur_nomain.o;\
	fi
